 ...
 * only safe together — which is exactly the bug PR #10 fixed in the sharp
 * pipeline, by adding a `.rotate()` call. This module is that same fix for the
 * code that runs in the tab, and it is now the only copy of it.
 *
