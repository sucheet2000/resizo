...
/**
 * The two the panel offers, default first.
 *
 * Black stays the default because it is what libvips does with no background
 * given, which keeps the sharp reference in the test suite agreeing with us and
 * keeps the pages that promise black true. But black is the wrong answer for a
 * logo or a flat graphic — which is most of what /png-to-jpg actually receives
 * — and the visitor is the only one who knows which they have. So it is offered
 * rather than decided.
 */
