 ...
 *
 * AVIF stores it as a separate monochrome AV1 item beside the picture rather
 * than as a fourth channel, which is an implementation detail everywhere except
 * one place: it is LOSSY at the same quality. Measured on an alpha ramp, the
 * largest error was 15/255 and every fully clear pixel stayed fully clear, so a
 * logo's hole is still a hole — which is the property this list is really
 * asserting.
 */
export const ALPHA_OUTPUT_FORMATS = ['png', 'webp', 'avif'];
