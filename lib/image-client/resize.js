 ...
 *
 * Verified against the real route in tests/api/resize-cover-parity.test.js:
 * for 200x100 asked for 50x50 this returns 100x50, and the pixels of a
 * scale-then-centre-extract at those numbers are byte-identical to what
