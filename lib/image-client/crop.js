 ...
 *
 * NOTHING IS RE-DERIVED HERE. parseCropParams and isCropInBounds are the exact
 * helpers app/api/crop/route.js uses, so a rectangle the server would have
 * rejected with 400 is rejected here with the same sentence. This module only
 * adds the two things the server got from sharp: the ordering of those two
