 ...
 * link label and blurb, the application name), the body (procedure, sections,
 * limits, FAQs, the feature list, the sibling-block heading), or both. Link
 * markup is reduced to its labels.
 */
