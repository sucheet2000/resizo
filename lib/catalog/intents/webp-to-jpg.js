...
const webpToJpg = {
    ...
    changes: {
        does: [
            'Decodes the WebP and re-encodes those pixels as JPEG at quality 80, a second lossy generation '
                + 'for most files.',
            'Fills in every transparent area before the JPEG is written, on white unless the panel is set '
                + 'to black or to a colour you name.',
        ...
        steps: [
            ...
            },
            {
                ...
                text: 'Your device decodes the WebP and writes a JPG at quality 80, at the same pixel dimensions. Any '
                    + 'transparency is flattened onto white, and an animation keeps only its first frame.',
            },
            {
            ...
            blocks: [
                {
                    ...
                    text: 'A WebP can hold an alpha channel and JPEG cannot, so any transparent area is filled in '
                        + 'on the way out. White is what it gets unless you say otherwise, on the reasoning that '
                        + 'a file being converted to open somewhere else is usually about to be printed, '
                        + 'attached or pasted onto a white page; the control above the button holds black and a '
                        + 'colour picker for everything else. When the transparency is the point — a logo, a '
                        + 'cut-out — convert to PNG instead. PNG output is lossless and keeps the alpha channel '
                        + 'untouched.',
                },
                {
                    type: 'p',
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: 'JPEG has no alpha channel, so the transparent areas are filled with a solid colour, and that '
                + 'colour is white until you change it above the button. Black and a colour picker are both '
                + 'there if white is wrong for your file. If you need the transparency itself, convert to PNG '
                + 'instead on the main converter page: PNG output is lossless and keeps the alpha channel '
                + 'exactly as it was.',
        },
        {
