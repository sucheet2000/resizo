            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: 'Where there is a ceiling on file size at the other end, a lossless format is the wrong '
                        ...
                        + 'or hand the PNG to the [compressor](/compress), which offers to write a lossless source '
                        + 'out as a JPEG for exactly this reason: there is no quality to turn down.',
                },
            ],
        },
        {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: 'The panel takes a single file per run, with a 20 MB ceiling no iPhone still photo comes '
                        + 'close to, and there is no batch mode for this format anywhere on the site. A folder has '
