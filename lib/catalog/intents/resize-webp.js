...
const resizeWebp = {
    ...
    h1: 'Resize a WebP',
    intro: 'Give it a width in pixels, a percentage or a platform size. What comes back is a WebP.',
            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: `A single file may be up to ${formatFileSize(MAX_FILE_SIZE)}, and neither side of the `
                        + `picture may pass ${MAX_DIMENSION} pixels going in or coming out. The work itself is `
