...
const compressImageTo50kb = {
    ...
    application: {
        ...
        features: [
            ...
            'Holds quality at 50 or above, so a face never turns to blocks',
    ...
    sections: [
        ...
        },
        {
            ...
            blocks: [
                ...
                {
                    type: 'p',
                    text: 'Under the fit policy the quality dial is searched first, and it stops at 50: below that '
    ...
    limitations: [
        ...
        'Quality is held at 50 or above under this policy, so a very large photograph gets under 50 KB by giving up pixels rather than by turning blocky.',
