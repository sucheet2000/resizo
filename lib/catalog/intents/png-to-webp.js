...
const pngToWebp = {
    ...
    answer: 'WebP is how a transparent graphic gets smaller without giving up the transparency: it keeps '
        + 'the alpha channel that a JPG would fill in with a solid colour, and it stores the same picture in '
            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: 'It is the whole reason this page exists separately from PNG to JPG. JPEG has no alpha '
                        + 'channel at all: send the same logo there and every transparent pixel comes back white, or the colour you pick. '
