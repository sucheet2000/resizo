 ...
 *
 *   Eight tools re-encode.  resize, crop, compress, the bulk compressor,
 *     convert, heic, the signature resizer and the passport photo tool all run
 ...
 *     are "removed" for all eight, and that is a consequence of the
 *     architecture rather than a promise someone made. The passport tool
 *     differs on one row only: it can
...
export const BEHAVIOUR = {
    ...
    'bulk-image-compressor': {
        ...
        dpi: 'removed',
        transparency: 'kept',
        note: 'Each file gets its own target and comes back in the format it arrived in — a JPEG stays a JPEG, a PNG a PNG, a WebP a WebP — so transparency is kept where the format keeps it. Nothing else about the original file survives the encode.',
    },
    convert: {
        pixels: 'reencoded',
        exif: 'removed',
