 ...
 *
 *   Nine tools re-encode.  resize, crop, compress, the bulk compressor,
 *     convert, the bulk converter, heic, the signature resizer and the passport
 *     photo tool all run
 ...
 *     are "removed" for all nine, and that is a consequence of the
 ...
 *     tool differs on one row only: it can
