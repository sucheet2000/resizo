...
export const ICON_SOURCES = [
    ...
    },
    {
        ...
        status: 'documented-by-apple',
        claim: 'Apple’s Human Interface Guidelines are written for native app icons, and they argue against transparency: "provide square layers so the system can apply rounded corners", "The system masks all layer edges to produce an icon’s final shape", and a background layer that is "full-bleed and opaque". A web clip added from Safari is drawn as an icon beside those, so this page suggests a background for the touch icon and leaves the choice to you.',
        source: {
