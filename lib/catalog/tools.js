...
export const TOOLS = [
    ...
    // header bar: the bar carries the tools people arrive for, and these are
    // one click away in /tools and in the Related Tools block of every page.
    // The first is a workflow — crop, size, format, byte ceiling in one pass —
