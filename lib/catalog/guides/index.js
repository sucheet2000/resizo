 ...
 *
 * A GUIDE FOLLOWS ITS MEASUREMENT. The two entries here are written from
 * benchmarks/results/latest.json, and a guide invented ahead of a measurement
 * is the exact thing this content type refuses to be. An empty registry is a
 * valid registry: /guides still renders and stays indexable, the route
 * prerenders nothing, and the sitemap gains no guide URL.
 */
