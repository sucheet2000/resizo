            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: `The graphic is the one sample that arrived with an alpha channel, and it needs a `
                        ...
                        + `scoring this sample without compositing put the WebP lane at 20 dB against the JPEG `
                        + `lane's 43 — the metric reading the half of the image nobody ever sees. So the graphic's `
