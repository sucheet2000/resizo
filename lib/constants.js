...
// A Vercel serverless function rejects a request BODY over 4.5MB with a 413, so
// a file at or below this stays on the fast multipart path and anything above
// it is uploaded straight to Vercel Blob and processed from there. The headroom
// under 4.5MB covers the multipart boundaries and the option fields that ride
// in the same body.
...
export const TOOLS = [
    ...
    },
    {
        ...
        shortTitle: 'Convert',
        description: 'Convert between JPEG, PNG, WebP, and AVIF instantly.',
        hasOwnPage: true,
    },
    {
        slug: 'crop',
