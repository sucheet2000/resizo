 ...
 *
 * Google only renders a HowTo when the markup describes steps the page really
 * shows, so a caller hands the SAME array to this builder and to
 * `components/content/HowToSteps.js`. Two lists that can drift apart is the
