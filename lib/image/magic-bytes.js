 ...
 */
/**
 * How many bytes off the front of a file every caller has to read before
 * sniffImageType can answer. Twelve is the longest check below (RIFF/WEBP and
 * the ftyp brand); sixteen is that rounded up, and it is exported so the intake
 * paths cannot each pick their own number and then disagree about how much of a
 * file a signature check needs.
 */
