        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-8 items-center">
            ...
            <div className="relative group py-2">
              <button className="text-sm font-medium text-[#C4AA87] group-hover:text-[#F5ECD7] transition-colors focus-visible:ring-2 focus-visible:ring-[#B8860B] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0D0A08] focus-visible:outline-none rounded flex items-center gap-1">
                Tools
